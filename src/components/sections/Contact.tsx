...
export const Contact = () => {
  ...
  const motionConfig = {
    ...
    delay1: isMobile ? 0 : 0.2,
    delay2: isMobile ? 0 : 0.4,
  };
    ...
    <section id="contact" className="section-padding relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* FORM */}
          <motion.div
            initial={{ opacity: 0, x: -motionConfig.x }}
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{
              duration: motionConfig.duration,
              delay: motionConfig.delay1,
            }}
          >
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className={`w-full py-4 rounded-xl font-medium text-primary-foreground flex items-center justify-center gap-2 transition-all ${
                    isLoading
              ...
              <div className="glass-card rounded-2xl p-6 hover-lift">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:kelvincedcas@gmail.com"
